                        ...
                        <div class="col-xs-12 col-sm-4 emphasis">
                            ...
                            <div class="btn-group dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu text-left">
                                    <li><a href="#"><span class="fa fa-envelope"></span>&nbsp;Send an email</a>
                                    </li>
                                    <li><a href="#"><span class="fa fa-list"></span>&nbsp;Add or remove from a list</a>
                                    </li>
                                    <li class="divider"></li>
                                    <li><a href="#"><span class="fa fa-warning"></span>&nbsp;Report this user for spam</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
